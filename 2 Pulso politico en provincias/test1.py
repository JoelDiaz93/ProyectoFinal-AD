...
twitterStream.filter(track=['Pulso Politico','Guillermo Lasso','Presidente','Alcade','Embajadores','Politica','Borrero','Vicepresidente','Corrupción'])
