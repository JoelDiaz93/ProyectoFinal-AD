...
'''===============API TWITTER=============='''
ckey = "VER0CB2cKlwDz1FRUCGxQnAEj"
csecret = "uyLI7NjlyXHfRXAeSrjfYvwCe7AFM7FfcBQajUSprpvyktpAtW"
atoken = "2353244641-3MQbokrQHEJIgHmzB7y0T1iVtw1VVrXgroSeUgF"
asecret = "HQLYghs2n7y0oIBfTBtRzUJmRc7Tkrb8gkzUdun3sDEA1"
...
class listener(StreamListener):
    def on_data(self, data):
        ...
        try:
            ...
            doc= provincia.insert(dictTweet)
...
'''===============TRACK=============='''
# Palabras para realizar busqueda relacionada con el pulso politico en Ecuador
twitterStream.filter(track=['Pulso Politico','Guillermo Lasso','Presidente','Alcade',
                            'Embajadores','Politica','Borrero','Vicepresidente','Corrupción'])
